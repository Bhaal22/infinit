...
public class GitHubTreeProcessorTests
{
    ...
    public async Task ProcessTree_WithFilters_OnlyProcessesMatchingItems()
    {
        ...
        var tree = new GitHubTree
        {
            ...
            {
                new GitHubTreeItem { Path = "lib/test1.js", Url = "url1", Type = "blob" },
                new GitHubTreeItem { Path = "test2.txt", Url = "url2", Type = "blob" },
                new GitHubTreeItem { Path = "lib/test3.js", Url = "url3", Type = "blob" },
        ...
        var processor = new GitHubTreeProcessor(mockClient.Object, new List<IGitHubDataFilter> { new TreeItemFilter(), new JsFileFilter() });
